...
두 파일의 HEAD 부분과, NUMBER의 숫자도 같을 경우, 원래 입력에 주어진 순서를 유지한다. MUZI01.zip과 muzi1.png가 입력으로 들어오면, 
...
/* SOLUTION */
// idea : 주어진 배열의 각 항목을 {head, number, tail}의 객체로 나누고 차례대로 정렬을 한다. 대소문자를 가리지 않는다 (통일 시킨 후 정렬), 숫자는 숫자로 변경 후 비교
// - 각 배열의 항목을 세개의 property를 갖는 객체로 쪼개는 함수 필요
// - head, number 순서로 정렬하기
